...
public class Localization {
    ...
    /// "Button title"
    /// "Skip"
    public static var gereral_skip: String { localized(key: "gereral_skip") }
    ...
    /// "\"Decrypting:\""
    public static var prepare_preview_message: String { localized(key: "prepare_preview_message") }
    ...
    /// "Button title"
    /// "Skip"
    public static var retry_view_button_skip: String { localized(key: "retry_view_button_skip") }
