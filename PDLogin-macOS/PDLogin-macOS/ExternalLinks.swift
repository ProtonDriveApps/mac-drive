...
public class ExternalLinks {
    public static let passwordReset = URL(string: "https://account.proton.me/reset-password")!
    public static let accountSetup = URL(string: "https://account.proton.me/")!
    public static let termsAndConditions = URL(string: "https://proton.me/legal/terms-ios")!
